...
abstract class SwipeToEditCallBack(context: Context):ItemTouchHelper.SimpleCallback(0,ItemTouchHelper.RIGHT) {
    ...
    override fun onChildDraw(
        ...
        val editIconsMargin=(itemHeight - intrinsicHeight)
        val editIconLeft = itemView.left + editIconsMargin - intrinsicWidth
        val editIconRight=itemView.left + editIconsMargin
